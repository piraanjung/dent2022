        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="card-body">
                        <a class="btn btn-app col-lg-3 col-6" style="height: 8rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-app col-lg-3 col-3" style="height: 8rem;">
                    ...
                    <div class="card-body">
                        <a class="btn btn-app col-lg-3 col-12" style="height: 8rem;">
                          <i class="fas fa-edit"></i> วันให้บริการประจำเดือน
                        </a>
                        <a class="btn btn-app col-lg-3 col-12" style="height: 8rem;">
                          <i class="fas fa-play"></i> ข้อมูลหมอ
                        </a>
                        <a href="{{url ("treatment") }}" class="btn btn-app col-lg-3 col-12" style="height: 8rem;">
